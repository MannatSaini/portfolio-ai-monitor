    ...
    <ChartContainer config={chartConfig} className="h-[400px] w-[1320px]">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data}>
          ...
          <Legend />
          <Line type="monotone" dataKey="personal" stroke="var(--color-personal)" strokeWidth={2} />
          <Line type="monotone" dataKey="auto" stroke="var(--color-auto)" strokeWidth={2} />
          <Line type="monotone" dataKey="mortgage" stroke="var(--color-mortgage)" strokeWidth={2} />
          <Line type="monotone" dataKey="business" stroke="var(--color-business)" strokeWidth={2} />
        </LineChart>
      </ResponsiveContainer>
    </ChartContainer>
  )
