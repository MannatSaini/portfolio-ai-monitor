    ...
    <Dialog open={showNewTeamDialog} onOpenChange={setShowNewTeamDialog}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new team to manage risk insights and collaborate with your colleagues.
          </DialogDescription>
        </DialogHeader>
        <div>
          <div className="space-y-4 py-2 pb-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Risk Analytics Team" />
            </div>
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="enterprise">
                    ...
                    <span className="text-muted-foreground">$19/month per user</span>
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
