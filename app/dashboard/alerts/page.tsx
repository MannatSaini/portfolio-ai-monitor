  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">Monitor and manage loan portfolio risk alerts.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your loan portfolio risk alerts</CardDescription>
        </CardHeader>
        <CardContent>
